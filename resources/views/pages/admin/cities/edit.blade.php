...
<div class="flex-grow px-8 py-4">
    ...
    <input type="text" name="name" value="{{$city->name}}" class="border border-grey-light border-solid w-4/5 block mx-auto px-4 py-4 rounded " id="name">
   </div>
   <div class="px-4 mb-8">
        <label class="font-semibold block text-center text-blue-darker mb-4 " for="slug">الشعار</label>
        <input type="text" name="slug" value="{{$city->slug}}" class="border border-grey-light border-solid w-4/5 block mx-auto px-4 py-4 rounded" id="slug">
    </div>
    <div class="px-4 mb-8">
