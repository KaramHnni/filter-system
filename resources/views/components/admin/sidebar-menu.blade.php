...
<a href="{{route('admin.users')}}" class=" block w-full text-center py-4  {{ request()->is('admin/users') ? 'bg-white text-black' : 'bg-blue-dark text-white' }} font-semibold border-b border-solid border-grey-light">Users</a>
    <a href="{{route('admin.administrators')}}" class="block w-full text-center py-4  {{ request()->is('admin/administrators') ? 'bg-white text-black' : 'bg-blue-dark text-white' }} font-semibold border-b border-solid border-grey-light">Administrators</a>
    <a href="{{route('admin.cities')}}" class="block w-full text-center py-4 {{ request()->is('admin/cities') ? 'bg-white text-black' : 'bg-blue-dark text-white' }} font-semibold border-b border-solid border-grey-light">Cities</a>
